...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    logic.loginTimerAnimationController = AnimationController(duration: const Duration(seconds: 60), vsync: this)
                                  ...
                                  children: [
                                    ...
                                    Center(
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(6.r), color: customFormfieldbackgroundColor),
                                        child: TabBar(
                                            onTap: (index) {
                                              if (index == 0) {
                                                                                ...
                                                                                onTap: () {
                                                                                  if (_loginLogic.loginTimerAnimationController!.value == 0.0) {
                                                                                    setState(() {
                                                                                      ...
                                                                                      _loginLogic.loginTimerAnimationController!.reverse(
                                                                                          from: _loginLogic.loginTimerAnimationController!.value == 0.0
                                                                                              ? 1.0
                                                                                              : _loginLogic.loginTimerAnimationController!.value);
                                                                                    });
                                                                                  }
                                                                                },
                                                                                child: Text(
                                                                                  ' resend_OTP_code'.tr,
                                                                                  style: _loginLogic.loginTimerAnimationController!.value != 0.0
                                                                                      ? const TextStyle(
                                                                                              fontSize: 14,
                                                                                      ...
                                                                                      : const TextStyle(
                                                                                          fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff727377)),
                                                                                ),
                                                                              ),
                                                                            ),
                                                                          ),
                                                                            ...
                                                                            child: Center(
                                                                              child: InkWell(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  decoration: BoxDecoration(
                                                                                      color: customThemeColor, borderRadius: BorderRadius.circular(8)),
                                                                                  child: Center(
                                                                                    child: Text(
                                                                                      'submit'.tr,
                                            ...
                                            TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                suffixIcon: InkWell(
                                                  ...
                                                  child: Icon(obscureText! ? Icons.visibility : Icons.visibility_off, size: 20, color: customtextDeepColor),
                                                ),
                                        ...
                                        InkWell(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              ...
                                              style: state.descTextStyle!.copyWith(color: customThemeColor, decoration: TextDecoration.underline, fontWeight: FontWeight.bold,)
                                            ),
                                          ),
                                        ),
                                      ],
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget? child) {
          return Text(timerString, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff727377)));
        });
  }
}
