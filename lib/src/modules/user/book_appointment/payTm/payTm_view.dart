...
class _PayTmState extends State<PayTm> {
  String mid = "Ddqckl36992914432459",
      orderId = "012",
      amount = "100",
      txnToken = "FLWSECK_TESTa144fbd78848";
  String result = "";
  ...
  Future<void> _startTransaction() async {
    try {
      var response = AllInOneSdk.startTransaction("Ddqckl36992914432459", "112",
          amount, "FLWSECK_TESTa144fbd78848", "DEFAULT", true, true, false);
      response.then((value) {
        print(value);
        setState(() {
