...
class GeneralController extends GetxController {
  ...
  Future<String?> getId(BuildContext context) async {
    ...
    if (Platform.isIOS) {
      ...
      postMethod(context, fcmUpdateUrl, {'token': '123', 'fcm_token': fcmToken, 'device_id': androidDeviceInfo.id, 'user_id': Get.find<GeneralController>().storageBox.read('userID')}, false,
          updateFcmTokenRepo);
